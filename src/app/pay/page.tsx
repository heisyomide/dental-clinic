...
// 1. Create a component for the actual payment logic
...
export default function PaymentPage() {
  return (
    <main className="min-h-screen bg-[#f0f9ff] flex items-center justify-center p-6">
      <Suspense fallback={
        <div className="text-[#1e4b8a] font-black uppercase tracking-widest animate-pulse">
          Loading Specialist Payment...
        </div>
      }>
        <PaymentContent />
      </Suspense>
